...
<?endif;?>
	  ...
	  <? if ($is_main_page):?>
        <div class="container">
          <h3 class="head__title">Партнеры</h3>
          <div class="row">
	...
	false
      ...
      <div class="container">
        <section class="sertificate">
          <h3 class="head__title">Сертификаты и Свидетельства</h3>
 ...
 <footer class="footer">
      ...
      <div class="row">
        ...
        <div class="footer__content">
          <div class="footer__company">
            <span>&copy <?=date('Y');?> ТОО "Жолбарыс Казахстан"</span>
          </div>
          ...
          <div class="footer__maxioma">
            <span>Разработка сайта - <a href="http://www.maxioma.kz" target="_blank">Maxioma</a></span>
          </div>
        </div>
    </div>
    </div>
  ...
  <? $APPLICATION->AddHeadScript(SITE_TEMPLATE_PATH.'/js/jqBootstrapValidation.js'); ?>
  <? $APPLICATION->AddHeadScript(SITE_TEMPLATE_PATH.'/js/mailer.js'); ?>
...
<noscript><div><img src="https://mc.yandex.ru/watch/56809111" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
</body>
</html>